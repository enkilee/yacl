...
def _com_github_herumi_mcl():
    maybe(
        ...
        strip_prefix = "mcl-1.89",
        sha256 = "9090db4541ec26d524096353cc1988e3ecf0157907309b06575b73ce05dc08a1",
        type = "tar.gz",
        ...
        urls = ["https://github.com/herumi/mcl/archive/refs/tags/v1.89.tar.gz"],
    )
